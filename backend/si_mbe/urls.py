...
urlpatterns = [
     ...
     path('dashboard/sparepart/edit/<int:sparepart_id>/', views.SparepartDataUpdate.as_view(),
          name='sparepart_data_update'),
     path('dashboard/sparepart/delete/<int:sparepart_id>/', views.SparepartDataDelete.as_view(),
