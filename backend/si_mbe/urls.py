...
urlpatterns = [
     ...
     path('admin/service/receipt/<int:service_id>/', views.ServiceReceipt.as_view(), name='service_receipt'),
     ...
     path('owner/report/sales/download/', views.SalesReportDownload.as_view(), name='sales_report_download'),
     ...
     path('owner/mechanic/', views.MechanicList.as_view(), name='mechanic_list'),
     path('owner/mechanic/add/', views.MechanicAdd.as_view(), name='mechanic_add'),
     path('owner/mechanic/edit/<int:mechanic_id>/', views.MechanicUpdate.as_view(), name='mechanic_update'),
     path('owner/mechanic/delete/<int:mechanic_id>/', views.MechanicDelete.as_view(), name='mechanic_delete'),
]
